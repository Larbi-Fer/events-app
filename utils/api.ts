...
export const getEventsData = async (type: 'My_Tickets' | 'Organized_Events' | string, id: number | string, email: string) => await api.get(`/api/profile/${id}?type=${type}&userEmail=${email}`)
